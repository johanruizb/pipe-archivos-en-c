...
#define WRITE 1
 ...
 /*
  * El proceso padre generará un númeo 
  * entero aleatorio entre 1 y 1000, y
  * este número será enviado a su hij. 
  * El hijo imprimirá el mensaje “menor que 50” 
  * si el número es menor que 500 y “mayor o igual a 50” 
